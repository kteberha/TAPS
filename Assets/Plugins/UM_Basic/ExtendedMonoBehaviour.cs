...
namespace UModules
{
	...
	public abstract class ExtendedMonoBehaviour : MonoBehaviour
	{
		...
		/// public BoxCollider Box { get { return Get(ref _box); } }
		/// </example>
		...
		/// <example>
		/// private BoxCollider _box;
		/// public BoxCollider Box { get { return GetInChildren(ref _box); } }
		/// </example>
		public T GetInChildren<T>(ref T target, string gameObjectName = null, bool warnIfNotFound = true) where T : Component
		{
			if (target)
			{
				return target;
			...
			{
				if (gameObjectName is null)
				{
					target = GetComponentInChildren<T>();
				}
				else
				{
					target = this.gameObject.FindChild(gameObjectName).GetComponent<T>();
				}
		...
		/// <example>
		/// private BoxCollider _box;
		/// public BoxCollider Box { get { return GetInParent(ref _box); } }
		/// </example>
